...
const classBackgrounds = {
  Warrior: 'A seasoned veteran of numerous battles, honing their combat skills on the front lines.',
  Mage: 'A scholar of arcane mysteries, delving into ancient tomes to harness the power of magic.',
  Rogue: 'A skilled infiltrator and master of stealth, navigating the shadows with finesse.',
  Cleric: 'A devoted follower of divine forces, serving as a healer and protector of the faithful.',
};

const raceBackgrounds = {
  Human: 'Born into a diverse society, adapting to various cultures and professions.',
  Elf: 'An ancient race with a deep connection to nature and a profound appreciation for art and beauty.',
  Dwarf: 'Hailing from underground realms, skilled in craftsmanship and known for their resilience.',
...
const generateRandomCharacter = () => {
  ...
  const raceDescription = `A ${randomRace.toLowerCase()} with a rich cultural heritage. ${raceBackgrounds[randomRace]}`;
  const classDescription = `Skilled in the ways of ${randomClass.toLowerCase()}, ready to face any challenge. ${classBackgrounds[randomClass]}`;
